...
class SnakeGame extends CanvasGame {
    ...
    constructor(player, canvas, initial_length = 5) {
        ...
        this.snake = new Snake(initial_length,
            ...
            this.food2 = new Food(this.getCanvasBound(canvas));
        }
    ...
    startGame() {
        ...
        this.food2_interval = setInterval(this.food_tick2.bind(this), 9000);
    }
    ...
    stopGame() {
        ...
        clearInterval(this.food2_interval);
    }
    ...
    tick() {
        ...
        if (this.snake.move() == false) {
            ...
            if (this.food.hit(this.snake)) {
                ...
                let type = this.snake.eat(this.food);
                switch (type) { // bonus 3,4
                    case 0: 
                        this.snake_interval = setInterval(this.tick.bind(this), this.speed -= 1);  // bonus 2
                        break;
                        case 1:
                        this.health += 10;
                        if (this.health > 100) this.health = 100;
                        break;
                    case 2: this.health -= 5; break;
                    default: break;
                }
            ...
            // bonus 5
            if (this.food2.hit(this.snake)) {
                //TODO: if yes: 1. make the snake eat the food
                let type = this.snake.eat(this.food2);
                switch (type) { // bonus 3,4
                    case 0: 
                        this.snake_interval = setInterval(this.tick.bind(this), this.speed -= 1);  // bonus 2
                        break;
                ...
                //TODO: 2. increase the game score
                this.score += this.food2.length;
                //TODO: 3. add more food
                this.food2 = new Food(this.getCanvasBound());
...
class Snake {
    ...
    eat(food) {
        ...
        let type = Math.round(Math.random() * 2); //bonus 3, 4
        switch (type) {
            case 0: //normal food
